        ...
        ( newState, cmd ) =
            case ( model.state, msg ) of
                ...
                ( Model.LoadedPosts state, ConfigChanged change ) ->
                    let
                      stareActualizata = Model.PostsConfig.applyChanges change state.config
                      postariFiltrate = Model.PostsConfig.filterPosts stareActualizata state.posts
                    in 
                     ( Model.LoadedPosts { state | config = stareActualizata, posts = postariFiltrate } , Effect.NoEffect )
